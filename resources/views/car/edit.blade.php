                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group{{ $errors->has('country') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="country" id="input-country" class="form-control form-control-alternative{{ $errors->has('country') ? ' is-invalid' : '' }}" placeholder="{{ __('Country') }}" value="{{ old('country',$car->country) }}"  autofocus required>
                                ...
                                <div class="col-6">
                                    <div class="form-group{{ $errors->has('num_car') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="num_car" id="input-num_car" class="form-control form-control-alternative{{ $errors->has('num_car') ? ' is-invalid' : '' }}" placeholder="{{ __('ID') }}" value="{{ old('num_car',$car->num_car) }}" autofocus required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group{{ $errors->has('color') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="color" id="input-color" class="form-control form-control-alternative{{ $errors->has('color') ? ' is-invalid' : '' }}" placeholder="{{ __('Color') }}" value="{{ old('color',$car->color) }}" autofocus required >
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group{{ $errors->has('user_id') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="input-type">{{ __('User ID') }}</label>
                                        <input type="text" name="user_id" id="input-user_id" class="form-control form-control-alternative{{ $errors->has('user_id') ? ' is-invalid' : '' }}" placeholder="{{ __('User ID') }}" value="{{ old('user_id',$car->user_id) }}" autofocus required >
