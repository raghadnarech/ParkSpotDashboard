            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('walletuser.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf

                            <h6 class="heading-small text-muted mb-4">{{ __('Parking walletuser Detail') }}</h6>
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    <div class="form-group{{ $errors->has('user_id') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="number" name="user_id" id="input-user_id" class="form-control form-control-alternative{{ $errors->has('user_id') ? ' is-invalid' : '' }}" placeholder="{{ __('User_id') }}" value="{{ old('user_id') }}"  autofocus required >
