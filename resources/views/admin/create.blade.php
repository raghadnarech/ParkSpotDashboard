                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin.store') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <h6 class="heading-small text-muted mb-4">{{ __('Parking Admin Detail') }}</h6>
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group{{ $errors->has('zone_id') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="zone_id" id="input-zone_id" class="form-control form-control-alternative{{ $errors->has('zone_id') ? ' is-invalid' : '' }}" placeholder="{{ __('Zone ID') }}" value="{{ old('zone_id') }}"  autofocus required >
